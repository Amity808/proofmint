        ...
        <div className="mb-8">
          <div className="relative">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">
              <span className="brand-gradient-multi bg-clip-text text-transparent">My Receipts</span>
            </h1>
        ...
        <div className="mb-6">
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                selectedStatus === GadgetStatus.Active
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                selectedStatus === GadgetStatus.Stolen
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                selectedStatus === GadgetStatus.Misplaced
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
                selectedStatus === GadgetStatus.Recycled
