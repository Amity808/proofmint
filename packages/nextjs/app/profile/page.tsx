...
const Profile: React.FC = () => {
  ...
  const { writeContractAsync: writeProofMintAsync, error: errorInteracting } = useScaffoldWriteContract({
    contractName: "ProofMint",
  });
        ...
        <div className="flex-1 flex items-center justify-center p-4">
          <div className="text-center max-w-md mx-auto">
            ...
            <p className="text-gray-600 mb-6">
              You need to register a domain to access your profile. This creates your unique identity on the ProofMint
              network.
            </p>
        ...
        <div className="mb-8">
          <div className="relative">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">
              <span className="bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">Profile</span>
            </h1>
                ...
                {profileData.recentActivity.map((activity, index) => (
                  ...
                  >
                    <div className="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center flex-shrink-0">
                      <span className="text-green-600 font-bold">{activity.type.charAt(0).toUpperCase()}</span>
                    </div>
                ...
                <>
                  ...
                  <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 p-6">
                    <div className="flex items-center justify-between mb-6">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 mt-1">Domain: {merchantName}.proofmint.eth</p>
                      </div>
                      <div className="flex items-center gap-3">
                        <div
                          className={`px-3 py-1 rounded-full text-sm font-medium ${canIssueReceipts ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                            }`}
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      <div className="text-center p-4 bg-gray-50 rounded-lg">
                        ...
                        <div className="text-2xl font-bold text-gray-900">{merchantReceipts?.length || 0}</div>
                        <div className="text-sm text-gray-600">Total Receipts</div>
                      </div>
                      <div className="text-center p-4 bg-gray-50 rounded-lg">
                        <TrendingUp className="w-8 h-8 text-blue-600 mx-auto mb-2" />
                        <div className="text-2xl font-bold text-gray-900">{subscription?.[2]?.toString() || 0}</div>
                        <div className="text-sm text-gray-600">This Month</div>
                      </div>
                      <div className="text-center p-4 bg-gray-50 rounded-lg">
                        <Package className="w-8 h-8 text-purple-600 mx-auto mb-2" />
                        <div className="text-2xl font-bold text-gray-900">{subscription?.[3]?.toString() || 0}</div>
                    ...
                    {subscription ? (
                      <div className="space-y-4">
                        <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                          ...
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-medium ${subscription[0] === 0
                          ...
                          >
                            {subscription[0] === 0 ? "Basic" : subscription[0] === 1 ? "Premium" : "Enterprise"}
                          </span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                          <span className="font-medium text-gray-700">Status</span>
                          <span
                            className={`px-3 py-1 rounded-full text-sm font-medium ${subscription[4] ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                              }`}
                          >
                  ...
                  <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200 p-6">
                    ...
                    {merchantReceipts && merchantReceipts.length > 0 ? (
                      ...
                      <div className="text-center py-8 text-gray-500">No receipts issued yet</div>
                    )}
                  </div>
                </>
              )}
