...
import { Filter, Heart, MessageCircle, Search, Shield, Star, TrendingUp, Users } from "lucide-react";
...
const Social: React.FC = () => {
  ...
  const mockUsers = [
    ...
    },
    {
      ...
      isFollowedBy: false,
      trustScore: 78,
      badges: [{ id: "5", name: "Rising Star", type: "reputation" as const, color: "bg-blue-100 text-blue-800" }],
    },
  ];
        ...
        <div className="mb-8">
          <div className="relative">
            <h1 className="text-4xl font-bold text-gray-900 mb-2">
              <span className="brand-gradient-multi bg-clip-text text-transparent">Social Network</span>
            </h1>
