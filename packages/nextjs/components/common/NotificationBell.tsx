...
import { AlertCircle, Award, Bell, CheckCircle, Heart, Recycle, ShoppingBag, Users, X } from "lucide-react";
      ...
      >
        <Bell
          className={`w-6 h-6 transition-colors ${
            isOpen ? "text-brand-primary" : "text-gray-600 group-hover:text-brand-primary"
          }`}
        />
