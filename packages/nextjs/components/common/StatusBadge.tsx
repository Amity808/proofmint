        ...
        return {
          ...
          icon: (
            <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
              ...
              <path
                fillRule="evenodd"
                d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-8.293l-3 3a1 1 0 01-1.414 0l-3-3a1 1 0 011.414-1.414L9 9.586V7a1 1 0 112 0v2.586l1.293-1.293a1 1 0 011.414 1.414z"
                clipRule="evenodd"
              />
            </svg>
          ),
