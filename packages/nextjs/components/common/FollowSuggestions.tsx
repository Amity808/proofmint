...
import { CheckCircle, MapPin, Recycle, Shield, ShoppingBag, Star, Users, X } from "lucide-react";
...
const FollowSuggestions: React.FC<FollowSuggestionsProps> = ({
  ...
  const filteredSuggestions = displaySuggestions.filter(s => !dismissed.has(s.id)).slice(0, maxSuggestions);
          ...
          >
            <div className="flex items-start gap-3">
              ...
              <div className="relative">
                ...
                {/* Type Badge */}
                <div
                  className={`absolute -bottom-1 -right-1 w-6 h-6 rounded-full border-2 border-white flex items-center justify-center ${getTypeColor(suggestion.type)}`}
                >
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {suggestion.verified && <Shield className="w-4 h-4 text-brand-primary flex-shrink-0" />}
                    </div>
