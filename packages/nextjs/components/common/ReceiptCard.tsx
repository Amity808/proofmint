  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border overflow-hidden hover:shadow-md transition-shadow">
      ...
      <div className="h-48 bg-gray-200 flex items-center justify-center relative">
        {getProductImage() ? (
          <img src={getProductImage()} alt={getProductName()} className="w-full h-full object-cover" />
        ) : (
          <div className="text-gray-400 text-sm flex flex-col items-center">
      ...
      <div className="p-6">
        ...
        <div className="flex items-start justify-between mb-3">
          <h3 className="text-lg font-semibold text-gray-900 line-clamp-2">{getProductName()}</h3>
        </div>
        ...
        <div className="space-y-2 text-sm text-gray-600 mb-4">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-mono text-xs">
              {contractReceipt ? formatAddress(contractReceipt.merchant) : "N/A"}
            </span>
          </div>
          <div className="flex justify-between">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-semibold text-green-600">{formatPrice(getPrice())}</span>
          </div>
          <div className="flex justify-between">
