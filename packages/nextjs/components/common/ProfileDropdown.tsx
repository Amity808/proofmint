                        ...
                        <div className="flex border-b border-gray-100">
                            {menuItems.map((item) => (
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 text-sm font-medium transition-colors relative ${activeTab === item.id
                                    ...
                                    {notifications.map((notification) => (
                                        ...
                                        >
                                            <div className="flex items-start gap-3">
                                                <div className={`w-2 h-2 rounded-full mt-2 ${notification.unread ? "bg-brand-primary" : "bg-gray-300"
                                                    }`} />
                                                <div className="flex-1">
                            ...
                            {activeTab === "suggestions" && (
                                <div className="p-4 space-y-3">
                                    ...
                                    {suggestions.map((suggestion) => (
                                        <div key={suggestion.id} className="p-3 border border-gray-200 rounded-lg hover:border-brand-primary/30 transition-colors">
