...
export const ENSAvatar: React.FC<ENSAvatarProps> = ({
    ...
    const avatarSrc = ensAvatar || fallbackSrc || (displayName !== 'Not set' ? `https://avatars.jakerunzer.com/${displayName}` : null);
        ...
        return (
            <div className={`flex items-center space-x-3 ${className}`}>
                ...
                <div>
                    ...
                    {ensName && (
                        <p className="text-sm text-gray-500">ENS Verified</p>
                    )}
                </div>
            </div>
        );
