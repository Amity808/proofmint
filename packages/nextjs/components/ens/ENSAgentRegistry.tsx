...
export const ENSAgentRegistry: React.FC<ENSAgentRegistryProps> = ({
    className = '',
}) => {
        ...
        <div className={`bg-white rounded-lg border border-gray-200 p-6 ${className}`}>
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    Discover and interact with AI agents registered on the ENS protocol.
                    Each agent has verifiable capabilities and reputation scores.
                </p>
            </div>
            ...
            <div className="space-y-4">
                {agents.map((agent) => (
                    <div
                        key={agent.name}
                        className={`border rounded-lg p-4 cursor-pointer transition-colors ${selectedAgent?.name === agent.name
