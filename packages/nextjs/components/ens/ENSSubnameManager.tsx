...
export const ENSSubnameManager: React.FC<ENSSubnameManagerProps> = ({
    type,
    onSubnameCreated,
    className = '',
}) => {
    ...
    return (
        <div className={`bg-white rounded-lg border border-gray-200 p-6 ${className}`}>
            <div className="mb-6">
                <h3 className={`text-lg font-semibold text-${typeInfo.color}-600 mb-2`}>
                    {typeInfo.title}
                </h3>
                ...
                <div>
                    ...
                    <div className="flex space-x-2">
                        <input
                            ...
                            className={`flex-1 px-3 py-2 border rounded-lg focus:ring-2 focus:ring-${typeInfo.color}-500 focus:border-transparent ${subname && !isValid ? 'border-red-300' : 'border-gray-300'
                                }`}
                        />
                    ...
                    {isValid && subname && (
                        <p className="mt-1 text-sm text-green-600">
                            ✓ {getProofMintSubname(type, subname)} is available
                        </p>
                    )}
                </div>
