...
export const ENSPaymentRouter: React.FC<ENSPaymentRouterProps> = ({
    onPaymentInitiated,
    className = '',
}) => {
        ...
        <div className={`bg-white rounded-lg border border-gray-200 p-6 ${className}`}>
            <div className="mb-6">
                ...
                <p className="text-gray-600">
                    Send payments using ENS names instead of wallet addresses.
                    Perfect for cross-border transactions and human-readable payments.
                </p>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    {paymentStatus && (
                        <div className={`mt-1 text-sm ${paymentStatus.status === 'success' ? 'text-green-600' :
                                paymentStatus.status === 'error' ? 'text-red-600' :
                                    paymentStatus.status === 'resolving' ? 'text-blue-600' :
                                        'text-gray-500'
                            }`}>
